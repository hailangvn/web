odoo.define("web.web_charfield_autocomplete", function (require) {
    ...
    var FieldCharAutocomplete = FieldChar.extend({
        ...
        init: function (field_manager, node) {
            ...
            this.search_read_fields = this.options.fields || [
                this.search_value_field,
                this.search_display_field,
            ];
            this.search_limit = this.options.limit || 30;
        },
        initialize_content: function () {
            this._super(), this.setup_autocomplete();
        },
        ...
        get_autocomplete_domain: function (term) {
            var self = this;
            var domain = [[self.search_field, "ilike", "%" + term + "%"]];
        ...
        autocomplete_source: function (request, response) {
            ...
            var def = new Model(self.search_model).call("search_read", [domain], {
